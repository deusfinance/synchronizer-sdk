...
var fetchConducted = /*#__PURE__*/toolkit.createAsyncThunk('conducted/fetchConducted', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
  var results;
...
var conductedSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'conducted',
...
var fetchDetails = /*#__PURE__*/toolkit.createAsyncThunk('details/fetchDetails', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", Object.entries(response).reduce(function (acc, _ref2) {
            ...
            acc[symbol] = {
              name: data.name,
              sector: data.sector === 'stock' ? exports.Sector.STOCKS : data.sector === 'crypto' ? exports.Sector.CRYPTO : exports.Sector.FOREX,
              symbol: data.symbol,
...
var detailsSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'details',
...
var initialState$3 = {
  ...
  partnerFee: (_partnerFee = {}, _partnerFee[exports.Sector.STOCKS] = '0', _partnerFee[exports.Sector.CRYPTO] = '0', _partnerFee[exports.Sector.FOREX] = '0', _partnerFee[exports.Sector.COMMODITIES] = '0', _partnerFee[exports.Sector.MISC] = '0', _partnerFee),
  platformFee: (_platformFee = {}, _platformFee[exports.Sector.STOCKS] = '0', _platformFee[exports.Sector.CRYPTO] = '0', _platformFee[exports.Sector.FOREX] = '0', _platformFee[exports.Sector.COMMODITIES] = '0', _platformFee[exports.Sector.MISC] = '0', _platformFee)
};
var feesSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'fees',
...
var fetchQuotes = /*#__PURE__*/toolkit.createAsyncThunk('quotes/fetchQuotes', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
  var results;
  return runtime_1.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
...
var quotesSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'quotes',
...
var fetchSignatures = /*#__PURE__*/toolkit.createAsyncThunk('signatures/fetchSignatures', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
  var results;
  return runtime_1.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
...
var signaturesSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'signatures',
...
function useTotalFeeCallback() {
  ...
  return React.useCallback(function (sector) {
...
function useRegistrarPairs(chainId) {
  ...
  var _useMemo = React.useMemo(function () {
    return [getFee(exports.Sector.STOCKS).toNumber(), getFee(exports.Sector.CRYPTO).toNumber(), getFee(exports.Sector.FOREX).toNumber()];
  }, [getFee]),
      stockFee = _useMemo[0],
  ...
  return React.useMemo(function () {
    ...
    return conducted[chainId].map(function (_ref) {
      ...
      var fee = asset.sector === exports.Sector.STOCKS ? stockFee : asset.sector === exports.Sector.CRYPTO ? cryptoFee : forexFee;
      var longRegistrar = {
        id: id,
        chainId: chainId,
        ticker: asset.symbol,
        name: asset.name,
        sector: asset.sector,
        direction: exports.Direction.LONG,
        contract: address.getAddress(_long),
        sibling: _short,
        symbol: asset.longSymbol,
        price: quote["long"].price,
        fee: constructPercentage(fee),
        open: !!longSigs,
        token: new coreSdk.Token(chainId, address.getAddress(_long), 18, asset.symbol, asset.name)
      };
      var shortRegistrar = {
        id: id,
        chainId: chainId,
        ...
        name: asset.name,
        sector: asset.sector,
        direction: exports.Direction.SHORT,
        contract: address.getAddress(_short),
        sibling: _long,
        symbol: asset.shortSymbol,
        price: quote["short"].price,
        fee: constructPercentage(fee),
        open: !!shortSigs,
        token: new coreSdk.Token(chainId, address.getAddress(_short), 18, asset.symbol, asset.name)
      };
      return {
        id: id,
        "long": longRegistrar,
...
function useRegistrarByContract(contract, chainId) {
  ...
  return React.useMemo(function () {
    ...
    var registrar = lodash.find(registrars, function (obj) {
...
var _Providers;
var Providers = (_Providers = {}, _Providers[exports.SupportedChainId.FANTOM] = /*#__PURE__*/new providers.JsonRpcProvider('https://rpc.ftm.tools'), _Providers);

function usePartnerManager(chainId) {
  var address = React.useMemo(function () {
...
function useContract(chainId, address, ABI) {
  ...
  return React.useMemo(function () {
    return new contracts.Contract(address, ABI, provider);
...
var ZERO = /*#__PURE__*/bignumber.BigNumber.from('0');
...
function Updater$2(_ref) {
  ...
  React.useEffect(function () {
    ...
    if (partnerStocks) {
      ...
      dispatch(updatePartnerFee((_updatePartnerFee = {}, _updatePartnerFee[exports.Sector.STOCKS] = fee.toString(), _updatePartnerFee)));
    }
    ...
    if (partnerCrypto) {
      ...
      dispatch(updatePartnerFee((_updatePartnerFee2 = {}, _updatePartnerFee2[exports.Sector.CRYPTO] = _fee.toString(), _updatePartnerFee2)));
    }
    ...
    if (partnerForex) {
      ...
      dispatch(updatePartnerFee((_updatePartnerFee3 = {}, _updatePartnerFee3[exports.Sector.FOREX] = _fee2.toString(), _updatePartnerFee3)));
    } // platform
    ...
    if (platformStocks) {
      ...
      dispatch(updatePlatformFee((_updatePlatformFee = {}, _updatePlatformFee[exports.Sector.STOCKS] = _fee3.toString(), _updatePlatformFee)));
    }
    ...
    if (platformCrypto) {
      ...
      dispatch(updatePlatformFee((_updatePlatformFee2 = {}, _updatePlatformFee2[exports.Sector.CRYPTO] = _fee4.toString(), _updatePlatformFee2)));
    }
    ...
    if (platformForex) {
      ...
      dispatch(updatePlatformFee((_updatePlatformFee3 = {}, _updatePlatformFee3[exports.Sector.FOREX] = _fee5.toString(), _updatePlatformFee3)));
    }
...
function Updaters(_ref) {
  var chainId = _ref.chainId,
      partnerId = _ref.partnerId;
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Updater, null), React__default.createElement(Updater$1, null), React__default.createElement(Updater$2, {
    chainId: chainId,
    partnerId: partnerId
  }), React__default.createElement(Updater$3, null), React__default.createElement(Updater$4, null));
}
...
function Provider(_ref) {
  ...
  return React__default.createElement(reactRedux.Provider, {
    store: store
  }, React__default.createElement(React__default.Fragment, null, React__default.createElement(Updaters, {
    chainId: chainId,
    partnerId: partnerId
  }), children));
}
...
exports.useRegistrarPairs = useRegistrarPairs;
exports.useRegistrarTokenMap = useRegistrarTokenMap;
exports.useRegistrarTokens = useRegistrarTokens;
exports.useRegistrars = useRegistrars;
exports.useTotalFeeCallback = useTotalFeeCallback;
//# sourceMappingURL=synchronizer-sdk.cjs.development.js.map
